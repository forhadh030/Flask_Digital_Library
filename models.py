...
class Library(db.Model):
    ...
    def __init__(self,author_name,book_title,ISBN_number,book_length,user_token, id = ''):
        self.id = self.set_id()
    ...
    def __repr__(self):
        return f'The following books has been added to the digital library: {self.book_name}'
...
class LibrarySchema(ma.Schema):
    class Meta:
        fields = ['id', 'book_name','book_title','ISBN_number', 'book_length']
